        ...
        <article className="prose-protocol prose-spec">
          ...
          <nav className="mb-10 pb-6 border-b border-border">
            ...
            <ul className="flex flex-wrap gap-x-5 gap-y-2 text-sm list-none pl-0">
              <li><a href="#request-format" className="text-body underline underline-offset-2 hover:text-foreground">Request Format</a></li>
              <li><a href="#protocol-version" className="text-body underline underline-offset-2 hover:text-foreground">Protocol Version</a></li>
              <li><a href="#account-level-quotas" className="text-body underline underline-offset-2 hover:text-foreground">Quotas</a></li>
              <li><a href="#response" className="text-body underline underline-offset-2 hover:text-foreground">Response</a></li>
              <li><a href="#png-vs-snapshot" className="text-body underline underline-offset-2 hover:text-foreground">PNG vs Snapshot</a></li>
              <li><a href="#error-codes" className="text-body underline underline-offset-2 hover:text-foreground">Error Codes</a></li>
            </ul>
          </nav>

          {/* AI agent callout */}
          <div className="mb-10 p-4 border border-border bg-muted/30 rounded-sm text-sm text-body">
            <strong>For AI agents and automated tools:</strong> See the{" "}
            <Link to="/docs/ai-agent-contract" className="text-body underline underline-offset-2 hover:text-foreground">
              AI Agent Contract
            </Link>{" "}
...
{`{
  ...
  "protocolVersion": "1.2.0"
          ...
          <section>
            ...
            <h3>Quota Headers</h3>
            <p>Each successful render response includes quota headers:</p>
          ...
          <section>
            ...
            <p>A successful response returns a binary PNG image:</p>
            <ul>
            ...
            <p>The response includes verification headers:</p>
  ...
  "timestamp": "2025-01-27T..."
          ...
          <section className="mt-12 pt-8 border-t border-border">
            <p className="text-caption text-sm">
              ...
              {" · "}
              <Link to="/docs/cli" className="text-body underline underline-offset-2 hover:text-foreground">
                CLI Reference
              </Link>
              {" · "}
