    ...
    <PageLayout>
      ...
      <PageContent>
        ...
        <section className="mb-16">
          ...
          <p className="text-body">
            Modes such as Shapes, Noise, and Artnames are designed to support deterministic systems when all inputs are pinned and renderers conform to specified behavior.
          </p>
        </section>
