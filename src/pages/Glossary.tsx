    ...
    <PageLayout>
      ...
      <PageContent>
        ...
        <section className="mb-16">
          ...
          <p className="text-body">
            Protocol-enforced modes—Code Mode, SoundArt, Shapes, Noise, and Artnames—are fully deterministic and rendered exclusively via the NexArt Code Mode runtime with no legacy rendering paths.
          </p>
        </section>
        ...
        <section className="mb-16">
          ...
          <p className="text-body mb-4">
            Modes are not plugins or extensions. They are first-class protocol primitives, each with defined semantics and determinism characteristics. Protocol-enforced modes (Code Mode, SoundArt, Shapes, Noise, Artnames) execute through the shared NexArt runtime with determinism guarantees.
          </p>
          <p className="text-body">
