...
const faqItems = [
  {
    ...
    answer: "NexArt is a protocol and canonical execution system for deterministic generative computation. It allows code, inputs, and runtime to be executed in a standardized environment so results are reproducible, verifiable, and replayable at any point in the future."
  },
  {
    question: "What problem does NexArt solve?",
    answer: "Most generative systems — including simulations, models, and creative tools — cannot prove that the same inputs will always produce the same outputs. NexArt solves this by enforcing deterministic execution and producing cryptographic proofs that bind code, inputs, runtime, and output together."
  },
  {
    question: "Is NexArt only for generative art?",
    answer: (
      <>
        <p className="mb-3">No. While NexArt originated in generative art, the underlying system is general-purpose. It can be used for:</p>
  ...
  },
  {
    ...
    answer: (
      <>
        ...
        <p>Only outputs produced by the Canonical Renderer can be independently verified and used for archival, minting, or audit-grade certification.</p>
      </>
    )
  },
  {
  ...
  },
  {
    ...
    answer: "Execution happens off-chain for performance and cost reasons. However, outputs or execution proofs can optionally be anchored onchain (e.g. on Base) by storing a hash or Merkle root. This provides tamper-proof timestamping without high gas costs."
  },
  {
  ...
  },
  {
    ...
    answer: "Protocol versions are immutable once released. Snapshots always record the resolved protocol version, so past executions remain replayable even as the system evolves."
  },
  {
  ...
  },
  {
    ...
    answer: (
      <>
        <p className="mb-3">They can fork the code, but they cannot fake canonical trust. Certification value comes from:</p>
        <ul className="list-disc list-inside space-y-1 text-muted-foreground mb-3">
    ...
    answer: (
      <>
        <ol className="list-decimal list-inside space-y-1 text-muted-foreground">
          <li>Read the <Link to="/builders" className="text-link hover:text-link-hover underline underline-offset-2">Builders documentation</Link></li>
  ...
  return (
    <PageLayout>
      <Helmet>
        ...
        <meta name="description" content="Frequently asked questions about the NexArt Protocol, deterministic execution, certified renders, and the Canonical Renderer." />
      </Helmet>
