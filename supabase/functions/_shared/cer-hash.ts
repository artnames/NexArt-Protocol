/**
 * Canonical JSON + SHA-256 hashing for CER bundles (Deno edge function compatible).
 * Used only in re-attest to recompute certificateHash for redacted bundles.
 */
 ...
 * Meta and attestation fields are excluded by design.
 */
